...
function ajaxGetWeather(city){
    ...
    if (city != null){
         // 842bdb85d4d2bedcc01eefd1186a6732 user API code
        //Query URL variables
    var currentWeatherQuery = `https://api.openweathermap.org/data/2.5/weather?q=${city}&APPID=842bdb85d4d2bedcc01eefd1186a6732`;
    var fiveDayWeatherQuery = `https://api.openweathermap.org/data/2.5/forecast?q=${city},3166&APPID=842bdb85d4d2bedcc01eefd1186a6732`;
